...
const ICONS = {
  ...
  chevronDown: ['material', 'keyboard-arrow-down'],
  plus: ['material', 'add'],
  ...
  peopleOutline: ['material', 'people-outline'],
  personAdd: ['material', 'person-add-alt'],
  personRemove: ['material', 'person-remove'],
  personSearch: ['material', 'person-search'],
  deleteForever: ['material', 'delete-forever'],
  accept: ['material', 'check-circle'],
  decline: ['material', 'cancel'],
  chats: ['material', 'chat'],
